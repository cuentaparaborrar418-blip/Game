function decideSurvivorGoal(s) {
    ...
    // --- LÓGICA DE ESCAPE EN BORDES (EVITA QUEDAR ACORRALADO) [De ai (2).js] ---
    if (distToKiller < 320) {
    ...
    // --- SEGURIDAD AL CURARSE: Sube de 260 a 550 para evitar bucles absurdos [De ai (2).js] ---
...
function updateSurvivorAI(s) {
    ...
    // --- LÓGICA DE SALTO REPARADA Y OPTIMIZADA [De ai (2).js] ---
